...
if(!$_GET['idBlt']){
	header('Location: listaBoletimAluno.php');
}?>
...
$(document).ready(function() {
	...
	<div class="row">
		<div class="six columns">
			<button class="ui-button-new" onclick="location.href='index.php';" >Voltar para os boletins</button>
		</div>
	</div>
...
<table>
	...
	<div class="row">
		...
		<div class="two columns">
			<a href="imprimirBoletim.php?idBlt=<?=$_GET['idBlt']?>" class="button" target="_blank">Imprimir</a>
		</div>
	
		<div class="four columns">
		<label style="font-size: 18px;"> <strong>Média geral da etapa:</strong> <?= $mediaEtapa?> </label>
