<?php if(!$_GET['m'])include 'header.php';  ?>
			...
			$(document).ready(function() {
				...
				$( ".ui-button-new" ).button({
				 ...
				 $('#tabela').dataTable( {
				        ...
				        "bProcessing": true,
				        "bServerSide": true,
				        "sAjaxSource": "../helper/listaProf.php"
				      } );
	...
	<div class="row">
		<div class="four columns centered">
			<h3 id="titulo_pagina" class="titulo_page">Professores</h3>
		</div>
	</div>
		...
		<div id="container">
			...
			<button class="ui-button-new" onclick="location.href='formProfessor.php';" >Novo Professor</button>
			<div><br /></div>
