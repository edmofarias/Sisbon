		...
		<div class="twelve columns">
				<ul class="nav-bar">
				  ...
				  <li><a href="listaTurma.php">Turmas</a></li>
				   ...
				   <li class="has-flyout">
					    <a href="listaQuestoes.php">Questionário</a>
					    <a href="#" class="flyout-toggle"><span> </span></a>
					    <ul class="flyout">
					      <li><a href="gerarQuestionario.php">Gerar Questionário</a></li>
					    </ul>
				  </li>-->
				  <li><a href="index.php">Atualizações</a></li>
				</ul>
...
<div id="dialog_excluir" style="display: none;">
	<span id="dialog_excluir_texto"></span>
</div>

<div class="row" id="avisos">
	<div id="aviso_formulario" class="ui-state-highlight row" style="z-index: 1010; margin:0; padding-top: 3px;">
		    <span class="ui-icon ui-icon-info" style="float: left; margin-right: .3em; margin-top:2px;"></span>
		    <strong>Aviso:</strong>
