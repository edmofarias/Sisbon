...
//{{{ Output
  ...
  //print_r($aRow);
    ...
    $iEditar = '<a title="Editar" href="formAdmin.php?id='.$aRow[$aColumns[0]].'" ><img src="imagens/edit_1.png" /></a>';
    //$iRemover = '<a href="javascript:excluir('.$aRow[$aColumns[0]].') "><img src="imagens/delete_1.png" /></a>';
    $iRemover = '<a title="Excluir" id="excluir_'.$aRow[$aColumns[0]].'" href="#null" resposta="listaAdmin.php" titulo="Excluir Registro" caixa="dialog_excluir" action="../controllers/admin.php" onclick="excluirCadastro(\'excluir_'.$aRow[$aColumns[0]].'\',\''.$aRow[$aColumns[0]].'\')"><img src="imagens/delete_1.png" /></a>';
