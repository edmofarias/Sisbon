  ...
  //print_r($aRow);
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
      ...
      else if ( $aColumns[$i] != ' ' )
      {
        ...
        array_push($arrOutput, $valor);
      }
    }
    
       
    $iEditar = '<a title="Editar" href="formProfessor.php?id='.$aRow[$aColumns[0]].'" ><img src="imagens/edit_1.png" /></a>';
    //$iRemover = '<a title="Excluir" href="javascript:excluir('.$aRow[$aColumns[0]].') "><img src="imagens/delete_1.png" /></a>';
    $iRemover = '<a title="Excluir" id="excluir_'.$aRow[$aColumns[0]].'" href="#" resposta="listaProfessor.php" titulo="Excluir Registro" caixa="dialog_excluir" action="../controllers/professor.php" onclick="excluirCadastro(\'excluir_'.$aRow[$aColumns[0]].'\',\''.$aRow[$aColumns[0]].'\')"><img src="imagens/delete_1.png" /></a>';
