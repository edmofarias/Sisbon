...
//{{{ Output
  ...
  //print_r($aRow);
    ...
    $boletim = '<center><a title="Boletins" href="listaBol.php?idaln='.$aRow[$aColumns[2]].'&tur='.$_GET['turma'].'" ><img src="../imagens/boletim_1.png" /></a></center>';
    
    $sOutput .= '"'.str_replace('"', '\"',''.$boletim.''.$iEditar.' '.$iRemover.'').'",';
    
    array_push($arrOutput, $boletim);
