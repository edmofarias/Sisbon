 ...
 */
  ...
  {
  	$sql = 'SELECT SE.serie, T.nome 
  			FROM cjaf_turmas T LEFT JOIN cjaf_series SE ON T.serie = SE.id WHERE idTurma = "'.$id.'"';
...
//{{{ Output
  ...
  //print_r($aRow);
    ...
    $iRemover = '<a title="Excluir" id="excluir_'.$aRow[$aColumns[0]].'" href="#null" resposta="listaAluno.php" titulo="Excluir Registro" caixa="dialog_excluir" action="../controllers/aluno.php" onclick="excluirCadastro(\'excluir_'.$aRow[$aColumns[0]].'\',\''.$aRow[$aColumns[0]].'\')"><img src="imagens/delete_1.png" /></a>';
